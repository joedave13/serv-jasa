    ...
    <div class="text-serv-bg">
        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800"
                    href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('logout-dashboard-form').submit()">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" fill="white" />
                        <path
                ...
                <form action="{{ route('logout') }}" method="POST" id="logout-dashboard-form" style="display: none;">
                    @csrf
                </form>
            </li>
        </ul>
