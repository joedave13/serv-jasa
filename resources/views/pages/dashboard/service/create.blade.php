                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Keunggulan" type="text" name="service_advantage[]"
                                            id="service_advantage"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                            value="{{ old('service_advantage[]') }}">
                                        <input placeholder="Keunggulan" type="text" name="service_advantage[]"
                                            id="service_advantage"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                            value="{{ old('service_advantage[]') }}">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <select id="revision_limit" name="revision_limit"
                                            ...
                                            <option value="4">4 Revisi</option>
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Keunggulan..." type="text" name="user_advantage[]"
                                            id="user_advantage"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        <input placeholder="Keunggulan..." type="text" name="user_advantage[]"
                                            id="user_advantage"
...
<script type="text/javascript">
    ...
    $("#addTaglineRow").click(function() {
        var html = '';
        html += '<input placeholder="Tagline..." type="text" name="tagline[]" id="tagline" autocomplete="tagline" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
