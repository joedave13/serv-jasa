                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        <div class="flex items-center mt-1">
                                            ...
                                            <img src="{{ Storage::url(Auth::user()->user_detail->photo) }}"
                                                alt="photo-profile" class="rounded-full w-16 h-16 object-cover">
                                            @else
                                            <span class=" inline-block w-16 h-16 overflow-hidden bg-gray-100
                                                rounded-full">
                                            ...
                                            <input type="file" name="photo" id="choose" hidden>
                                            <label for="choose"
                                            ...
                                            <a href="{{ route('member.delete.photo.profile') }}"
                                                onclick="return confirm('Are you sure want to delete your profile photo?');"
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input placeholder="Your experience..." type="text" name="experience[]"
                                            class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
