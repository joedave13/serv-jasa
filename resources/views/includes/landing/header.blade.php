        ...
        <div class=" mx-auto flex flex-wrap flex-row items-center justify-between">
            ...
            <div @click.away="open = false" class="hidden lg:block relative" x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <img class="inline ml-3 h-12 w-12 object-cover rounded-full"
                        src="{{ Storage::url(Auth::user()->user_detail->photo) }}" alt="profile">
                    @else
                    <svg class="inline ml-3 w-12 h-12 object-cover object-center rounded-full text-gray-300"
